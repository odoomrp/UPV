...
class AccountMoveLine(models.Model):
    ...
    invoice = fields.Many2one('account.invoice', compute=_invoice,
                              string='Invoice', fnct_search=_invoice_search)
    ...
    amount_to_pay = fields.Float(string='Amount to pay', compute=amount_to_pay)
        store={
            'account.move.line': (lambda self, cr, uid,
                                         ids, context=None: ids,
                                  None, 20),
            'payment.order': (_get_move_lines_order,
                              ['line_ids'], 20),
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form',
        ...
        context = context or {}
        menus = [model_data_obj.get_object_reference(
